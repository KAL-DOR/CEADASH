-- ===================================
-- FINAL COMPREHENSIVE FIX FOR DEMO MODE (V2 - Error Handling)
-- Run this entire script in Supabase SQL Editor
-- ===================================

-- Step 1: Drop ALL existing anon policies to avoid conflicts
...
DROP POLICY IF EXISTS "anon_read_demo_org" ON public.organizations;
DROP POLICY IF EXISTS "anon_read_demo_profiles" ON public.profiles;
DROP POLICY IF EXISTS "anon_select_demo_contacts" ON public.contacts;
DROP POLICY IF EXISTS "anon_insert_demo_contacts" ON public.contacts;
DROP POLICY IF EXISTS "anon_update_demo_contacts" ON public.contacts;
DROP POLICY IF EXISTS "anon_delete_demo_contacts" ON public.contacts;
DROP POLICY IF EXISTS "anon_select_demo_processes" ON public.processes;
DROP POLICY IF EXISTS "anon_insert_demo_processes" ON public.processes;
DROP POLICY IF EXISTS "anon_update_demo_processes" ON public.processes;
DROP POLICY IF EXISTS "anon_delete_demo_processes" ON public.processes;
DROP POLICY IF EXISTS "anon_select_demo_calls" ON public.scheduled_calls;
DROP POLICY IF EXISTS "anon_insert_demo_calls" ON public.scheduled_calls;
DROP POLICY IF EXISTS "anon_update_demo_calls" ON public.scheduled_calls;
DROP POLICY IF EXISTS "anon_delete_demo_calls" ON public.scheduled_calls;
DROP POLICY IF EXISTS "anon_select_demo_transcriptions" ON public.transcriptions;
DROP POLICY IF EXISTS "anon_insert_demo_transcriptions" ON public.transcriptions;
DROP POLICY IF EXISTS "anon_update_demo_transcriptions" ON public.transcriptions;
DROP POLICY IF EXISTS "anon_delete_demo_transcriptions" ON public.transcriptions;
DROP POLICY IF EXISTS "anon_select_demo_activities" ON public.activities;
DROP POLICY IF EXISTS "anon_insert_demo_activities" ON public.activities;
DROP POLICY IF EXISTS "anon_update_demo_activities" ON public.activities;
DROP POLICY IF EXISTS "anon_delete_demo_activities" ON public.activities;
...
-- Step 3: Create anon policies for demo org
-- Organizations
...
SELECT 'SUCCESS! Policies created for contacts:' as message;
